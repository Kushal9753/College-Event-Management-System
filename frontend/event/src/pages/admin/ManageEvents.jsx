...
const ManageEvents = () => {
 ...
 <p className="text-gray-600 ">Create, update, and oversee all events across the platform.</p>
 </div>
 ...
 <p className="text-gray-500 text-lg font-medium">Event list will be displayed here.</p>
 <p className="text-gray-400 text-sm mt-1">Click "Create Event" above to get started.</p>
 </div>
 </div>
 </div>
 );
