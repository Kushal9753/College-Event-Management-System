/**
 * Manage Faculty — Tab Configuration
 * ------------------------------------
 * Config-driven inner tab navigation for the Manage Faculty page.
 * Each entry maps to a lazy-loaded sub-page under /admin/faculty/:tabId.
 *
 * To add a new tab, just add an entry here and create the matching component.
 */

const manageFacultyTabs = [
  {
...
export default manageFacultyTabs;
