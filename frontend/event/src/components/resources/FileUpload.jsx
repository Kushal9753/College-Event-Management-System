...
const FileUpload = ({ onUpload }) => {
 ...
 return (
 <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 transition-colors duration-200">
 ...
 <div className={`p-4 rounded-full bg-blue-100 transition-transform duration-300 ${isDragging ? 'scale-110' : ''}`}>
 ...
 <label className="block text-xs text-gray-500 mb-1.5 uppercase font-medium tracking-wide">Share With</label>
 <select 
 value={accessType}
 onChange={(e) => setAccessType(e.target.value)}
 className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 text-gray-800 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-shadow appearance-none cursor-pointer"
 >
 ...
 <div className="flex-1">
 <label className="block text-xs text-gray-500 mb-1.5 uppercase font-medium tracking-wide">
 ...
 className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 text-gray-800 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-shadow placeholder-gray-400"
 />
 </div>
 </div>
 </div>
 ...
 : 'bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white shadow-md hover:shadow-lg transform hover:-translate-y-0.5 focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 '
 }
 `}
 >
 {isUploading ? (
