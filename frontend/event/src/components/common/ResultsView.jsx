...
const POSITION_STYLES = {
 '1st': {
 row: 'bg-gradient-to-r from-amber-50 to-yellow-50 border-l-4 border-l-amber-400',
 badge: 'bg-gradient-to-r from-amber-400 to-yellow-500 text-white shadow-lg shadow-amber-500/30',
 },
 '2nd': {
 row: 'bg-gradient-to-r from-slate-50 to-gray-50 border-l-4 border-l-slate-400',
 badge: 'bg-gradient-to-r from-slate-400 to-gray-400 text-white shadow-lg shadow-slate-400/30',
 },
 '3rd': {
 row: 'bg-gradient-to-r from-orange-50 to-amber-50 border-l-4 border-l-orange-400',
...
const ResultsView = ({ role = 'admin' }) => {
 ...
 className="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-xl bg-white text-sm text-gray-900 placeholder-gray-400 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-shadow"
 />
 </div>
 ...
 className="px-4 py-2.5 border border-gray-200 rounded-xl bg-white text-sm text-gray-900 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 min-w-[200px]"
 >
 ...
 className="px-4 py-2.5 border border-gray-200 rounded-xl bg-white text-sm text-gray-900 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 min-w-[160px]"
 >
 ...
 className="px-4 py-2.5 text-sm font-medium text-gray-500 hover:text-gray-700 border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors"
 >
 Clear
 </button>
 )}
