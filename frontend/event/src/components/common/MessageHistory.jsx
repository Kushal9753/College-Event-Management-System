...
const MessageHistory = () => {
 ...
 <Icon d={ICONS.clock} size={18} className="text-violet-600 " />
 </div>
 <div>
 <h2 className="text-lg font-semibold text-gray-900 ">Message History</h2>
 <p className="text-xs text-gray-500 ">{stats.total} messages sent</p>
 </div>
 </div>
 ...
 bg-${s.color}-100 ${s.color}-900/20 text-${s.color}-700 ${s.color}-300`}>
 {s.count}
 ...
 <p className="text-sm font-medium text-gray-900 truncate max-w-[240px]">{m.subject}</p>
 ...
 <span className="inline-flex items-center gap-1.5 capitalize text-gray-800 ">
 ...
 <p className="text-gray-800 ">{m.readCount} of {m.totalCount} read</p>
 </div>
 <div>
 ...
 <Icon d={ICONS.search} size={32} className="mx-auto text-gray-300 mb-3" />
 ...
 <div className="flex gap-2">
 <button className="px-3 py-1 rounded text-xs font-medium bg-gray-100 text-gray-500 hover:bg-gray-200 transition-colors disabled:opacity-40" disabled>
 Previous
 </button>
 <button className="px-3 py-1 rounded text-xs font-medium bg-gray-100 text-gray-500 hover:bg-gray-200 transition-colors disabled:opacity-40" disabled>
 Next
