...
const EventList = ({ events, onRegister, onCancel, onViewDetails, emptyMessage = "No events found." }) => {
 if (events.length === 0) {
 return (
 <div className="flex flex-col items-center justify-center p-12 bg-white rounded-2xl border-2 border-dashed border-gray-200 animate-in fade-in zoom-in duration-300">
