...
const AdminCreateEvent = () => {
 ...
 <p className="text-sm text-gray-500 ">Admin-created events are auto-approved.</p>
 </div>
 </div>
 ...
 <label htmlFor="admin-faculty" className={labelClasses}>Assigned Faculty <span className="text-gray-400 font-normal">(optional)</span></label>
 <select
 multiple
 id="admin-faculty"
