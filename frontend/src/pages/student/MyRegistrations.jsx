...
const MyRegistrations = () => {
 ...
 <p className="text-gray-600 ">Manage your event registrations and payment statuses.</p>
 </div>
 ...
 <div key={reg._id} className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow flex flex-col md:flex-row justify-between items-center gap-4">
 ...
 <div>
 <h3 className="font-bold text-gray-900 ">{reg.event?.title || reg.event?.name || 'Event'}</h3>
 ...
 <p className="font-bold text-gray-900 ">₹{reg.amount || 0}</p>
 </div>
