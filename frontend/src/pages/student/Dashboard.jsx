...
const Dashboard = () => {
 ...
 <p className="text-gray-600 text-lg">Here's what's happening in your event circle.</p>
 </div>

 {/* Stats Grid */}
 <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
 <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
 <p className="text-sm font-medium text-gray-500 uppercase tracking-wider mb-2">Available Events</p>
 <div className="flex items-end justify-between">
 <h3 className="text-4xl font-bold text-gray-900 ">{availableCount}</h3>
 <button 
 ...
 <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
 <p className="text-sm font-medium text-gray-500 uppercase tracking-wider mb-2">My Registrations</p>
 <div className="flex items-end justify-between">
 <h3 className="text-4xl font-bold text-gray-900 ">{registeredCount}</h3>
 <button 
 ...
 <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
 <p className="text-sm font-medium text-gray-500 uppercase tracking-wider mb-2">Events Attended</p>
 <div className="flex items-end justify-between">
 <h3 className="text-4xl font-bold text-gray-900 ">{attendedCount}</h3>
 <span className="text-gray-400 text-sm">Well done!</span>
 </div>
 </div>
 </div>
 ...
 <p className="text-gray-500 ">No new events to preview.</p>
 </div>
 )}
 </div>
 </div>
