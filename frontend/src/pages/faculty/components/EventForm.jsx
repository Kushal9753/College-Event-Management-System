...
const EventForm = ({ isOpen, onClose, onSuccess }) => {
 ...
 required
 className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm p-2 bg-gray-50 bg-opacity-50"
 />
 </div>
 ...
 <div>
 <label className="block text-sm font-medium text-gray-700 ">Prize/Reward</label>
 <input
 type="text"
 name="prize"
