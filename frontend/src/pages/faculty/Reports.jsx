    ...
    <div className="max-w-7xl mx-auto p-4 lg:p-8 animate-fade-in font-sans">
      <div className="flex items-center gap-4 mb-10">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Generate analytics and reports for your events.</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-12 text-center flex flex-col items-center justify-center min-h-[300px]">
        ...
        <p className="text-gray-500 max-w-sm">The reporting module is under development. Exportable analytics will be available soon.</p>
      </div>
    </div>
  );
};
