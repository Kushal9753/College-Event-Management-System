...
const PaymentQRModal = ({ isOpen, onClose, registration, eventName }) => {
 ...
 <div className="text-center p-4 rounded-2xl border-2 border-dashed border-gray-200 ">
 <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Payment Status</p>
 <div className="flex items-center justify-center gap-2">
 <div className="w-2 h-2 rounded-full bg-yellow-500 animate-pulse"></div>
 <span className="text-sm font-bold text-gray-700 ">Waiting for transaction...</span>
 </div>
 </div>
 </div>
 </div>
