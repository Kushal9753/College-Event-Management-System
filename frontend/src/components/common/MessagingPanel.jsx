...
const MessagingPanel = () => {
 ...
 <Icon d={ICONS.send} size={18} className="text-blue-600 " />
 </div>
 <div>
 <h2 className="text-lg font-semibold text-gray-900 ">Compose Message</h2>
 <p className="text-xs text-gray-500 ">Send messages to faculty, students, or broadcast to all</p>
 </div>
 </div>
 ...
 {selectedRecipient ? (
 <div className="flex items-center justify-between px-4 py-2.5 rounded-lg border border-blue-200 bg-blue-50 ">
 <span className="text-sm text-gray-900 font-medium">
 {selectedRecipient.name}
 <span className="ml-2 text-xs text-gray-500 ">({selectedRecipient.department})</span>
 </span>
 ...
 <ul className="absolute z-30 mt-1 w-full max-h-48 overflow-auto rounded-lg border border-gray-200 bg-white shadow-lg">
 ...
 <div>
 <p className="text-sm font-medium text-amber-800 ">Broadcast Message</p>
 ...
 {groupMembers.map(m => (
 <span key={m._id}
 className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-700 ">
 {m.name}
 ...
 {isSelected && <Icon d={ICONS.check} size={16} className="text-blue-600 " />}
 </li>
 );
 }) : (
 <li className="px-4 py-3 text-sm text-gray-400 text-center">No results found</li>
